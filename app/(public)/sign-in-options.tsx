      ...
      <ImageBackground className="flex-1 px-[20] py-[40]" source={imageSource}>
         ...
         <View className="flex-1 items-center gap-y-5 justify-center">
            <Pressable
               ...
               className="bg-primary w-[320] h-[51] rounded-md items-center justify-center"
            >
            ...
            <Pressable className="bg-dark/70 flex-row backdrop-blur-sm w-[320] h-[51] gap-x-2 rounded-md items-center justify-center">
               <Ionicons
                  ...
                  color={"white"}
               />
               <Text className="text-white font-RedHatMedium">
                  Masuk dengan Google
               </Text>
            </Pressable>

            <Pressable className="bg-dark/70 flex-row w-[320] h-[51] rounded-md items-center gap-x-2 justify-center">
               <Ionicons
                  className="text-white"
                  name="logo-facebook"
                  size={20}
