import ForecastCardBackground from "@/components/ForecastCardBackground";
import ForecastParameter, {
   ForecastParametersItemProps,
} from "@/components/ForecastParameters";
import ForecastPerHour from "@/components/ForecastPerHour";
...
const Forecast = () => {
   ...
   return (
      <View className=" flex-1 px-[20] py-[18] bg-white">
